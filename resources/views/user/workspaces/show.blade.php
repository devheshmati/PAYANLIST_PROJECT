    ...
    <meta name="update-status-url"
        content="{{ route('workspaces.tasks.updateStatus', ['workspace' => '__WORKSPACE__', 'task' => '__TASK__']) }}">
                    ...
                    <div class="flex justify-center">
                        ...
                        <div class="p-4">
                            ...
                            <form method="POST" action="{{ route('workspaces.tasks.store', $workspace) }}"
                                ...
                                <div>
                                    <button type="submit" class="bg-purple-600 rounded-lg px-4 py-2">Create
                                        Task</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="p-4">
                            ...
                            <form method="POST" action="{{ route('user.workspace.invite', $workspace) }}"
                                ...
                                <div>
                                    <button type="submit" class="bg-purple-600 rounded-lg px-4 py-2">Invite
                                        User</button>
                                </div>
                            </form>
                        </div>
