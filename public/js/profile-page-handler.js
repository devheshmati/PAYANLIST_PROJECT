window.addEventListener("DOMContentLoaded", function () {
    ...
    const firstNameActivator = document.querySelector(
        "#first-name-activator-btn",
    );
    const lastNameActivator = document.querySelector(
        "#last-name-activator-btn",
    );
    const jobTitleActivator = document.querySelector(
        "#job-title-activator-btn",
    );
    ...
    // skill modal
    const closeSkillModalBtn = document.querySelector(
    ...
    function handleSubmitAvatarModal(e) {
        ...
        if (file && file.size > 512000) {
            ...
            e.preventDefault();
            alert(
                "Image size is to large, your image should be less then 500kb",
            );
        }
    }
});
